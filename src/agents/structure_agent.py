...
class StructureAgent(BaseAgent):
    ...
    def ask(self, info: dict, knowledge: str) -> str:
        ...
        sys_prompt = "请根据上述目标以及给出的知识点，确定题目的结构。如果是简答题，那么你需要给出题目共设置几个小问，每个小问的难度，以及每个小问考察的知识点，并确保题目难度随小问逐级递增；如果是选择题，那么你需要给出题目难度、考察的知识点以及干扰选项的大致方向；如果是填空题，那么你应该给出总共有几个空（只允许1个或2个），每个空的难度和考察的知识点。请注意，在回答中不需要包含题目的具体内容或答案。"
